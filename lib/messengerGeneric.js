...
let messengerGeneric = {
    ...
    sendPropertyResults( recipientId, results ) {
      ...
      messengerGeneric.sendTypingOff( recipientId );
        ...
        var that = this;
        setTimeout(function(){
          that.sendTextMessage( recipientId, "Let me know how else I can help you. Feel free to send me another address if you want me to look up more applications for you." );
        }, 1500);
    },
