...
let messengerGeneric = {
    ...
    sendSingleApplication( recipientId, application ) {
        ...
        //send image post
        //this.sendImageMessage(recipientId, googleMapImg.getMapImageUrlAddress( result.application.address ));
    ...
    sendPropertyResults( recipientId, results ) {
        ...
        var that = this;
        setTimeout( function () {
            that.sendTextMessage( recipientId, 'Select "MORE INFO..." on a property above or send me another location and I\'ll do another search for you.' );
        }, 3000 );
    },
