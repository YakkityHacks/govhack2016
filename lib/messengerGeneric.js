...
let messengerGeneric = {
    ...
    sendPropertyResults( recipientId, results ) {
      ...
      //show success text
      this.sendTextMessage( recipientId, "Done! Found " + results.length + " development applications near the area you selected:" );
      messengerGeneric.sendTypingOff( recipientId );
        ...
        results.forEach( result => {
            ...
            var element = {
                ...
                buttons: [ {
                    type: "web_url",
                    title: "More info",
                    url: result.application.info_url,

                } ],
            };
            if ( result.application.comment_url && result.application.comment_url.indexOf( 'http' ) !== -1 ) {
                element.buttons.push( {
                    type: "web_url",
                    title: "Official comment",
                    url: result.application.comment_url,
                } );
            }
            if ( false ) {
                //Postback example
        ...
        //more actions text
        this.sendTextMessage( recipientId, "Let me know how else I can help you. Feel free to send me another address if you want me to look up more applications for you." );
    },
