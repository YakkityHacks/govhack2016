...
let botLoop = {
    ...
    receivedMessage( event ) {
        ...
        if ( messageText ) {
            ...
            case 'hi':
            case 'Hi':
                messengerGeneric.sendTextMessage( senderID, 'Hi! How are you today? Where in would you like me search for development applications?' );
                break;
            ...
            messageAttachments.forEach( attachment => {
                if ( attachment.type === 'location' ) {
                    ...
                    //about to search text
                    messengerGeneric.sendTextMessage( senderID, "Thanks for that! Let me get you those applications ASAP" );
                    ...
                    request.get( 'https://api.planningalerts.org.au/applications.js', {
                        ...
                        return messengerGeneric.sendPropertyResults( senderID, filtered );
                    } );
                }
            } );
            if ( !replied ) {
