    ...
    receivedPostback( event ) {
        ...
        case 'MORE_INFO':
            ...
            request.get( 'https://api.planningalerts.org.au/applications.js', {
                ...
                if ( error ) throw error;
                console.log( 'Single property result', JSON.stringify( body, null, '    ' ) );
                if ( body.length === 0 ) {
                    console.log('error here')
                    return messengerGeneric.sendTextMessage( senderID, 'An unknown error happened. Please try again.' );
                }
